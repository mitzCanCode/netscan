...
const availableCommands = ["scan", "results", "check 1", "sniff", "qscan", "help", "exit"];
let currentIndex = 0;
...
function changeCommand() {
    ...
    setTimeout(() => {
        ...
        if (commandElement.textContent === "scan") {
            ...
            resultsElement.innerHTML = `<span class="scanning">Scanning...</span>
Getting router IP
Getting subnet mask..
...
6\t192.168.3.146\t04:d6:f4:cd:75:78\tDevice7\t\tVendor7`;
            ...
            const resultsElement = document.querySelector('.results');
            resultsElement.innerHTML = `Packet: Ether / IP / TCP 20.42.65.90:https > 192.168.3.74:63805 RA / Padding | Source IP: 20.42.65.90  |  Source MAC: 76:ac:b9:16:49:3c | Destination IP: 192.168.3.74  |  Destination MAC: 3c:22:fb:02:4b:b5 | Protocol: TCP | Time: 02-06-2024_11:26:04
--------------------------------------------------
...
--------------------------------------------------`;
            ...
            const resultsElement = document.querySelector('.results');
            resultsElement.innerHTML = `ID\tIP ADDRESS\tMAC ADDRESS\t\tDEVICE NAME\tVENDOR
0\t192.168.3.1\t76:ac:b9:16:49:3c\tDevice1\t\tVendor1
1\t192.168.3.2\t76:ac:b9:16:49:3c\tDevice2\t\tVendor2
2\t192.168.3.78\t8a:c7:d6:59:50:89\tDevice3\t\tVendor3
3\t192.168.3.85\t7a:72:1c:26:6a:01\tDevice4\t\tVendor4
...
6\t192.168.3.146\t04:d6:f4:cd:75:78\tDevice7\t\tVendor7`;
            ...
            const resultsElement = document.querySelector('.results');
            resultsElement.innerHTML = `Total hosts up: 6
...
192.168.3.146`;
            ...
            // Update the content of the results span for ID 0
            const resultsElement = document.querySelector('.results');
            resultsElement.innerHTML = `1. scan		- Initiate a network scan
2. qscan	- Do a quick ping sweep to see which hosts are up and which are down
...
For more inforamtion on a command use: [COMMAND] -h`;
        } else if (commandElement.textContent === "check 1") {
            // Check if the ID is 0
            // Update the content of the results span for ID 0
            const resultsElement = document.querySelector('.results');
            resultsElement.innerHTML = `Checking IP address 192.168.3.2
Scan started
Scanning 192.168.3.2 for common ports...
Open ports on 192.168.3.2:
Port 53: DNS
Port 80: HTTP
Port 8080: HTTP-Proxy`;
            ...
            // Update the content of the results span for ID 0
            const resultsElement = document.querySelector('.results');
            resultsElement.innerHTML = `Quitting...`;
        }
